<?php use moviexpert\Http\Controllers\FrontendController;
	...
	<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 cuadrado">
		<ul class="nav nav-tabs">
			...
			<li class=""><a class="textoFicha" href="{{ url('/top10/') }}">Top 10</a></li>
		</ul>
		<div class="col-xs-12">
				...
				@foreach($peliculas as $pelicula)
			        ...
			        <div class="  colorNegro negrita"> <span class="titulosPeliculas negrita">Año: </span>{{$pelicula->anio}}</div>
							<div class="colorNegro  negrita"><span class="titulosPeliculas negrita">Director: </span> {{$pelicula->director}}</div>
